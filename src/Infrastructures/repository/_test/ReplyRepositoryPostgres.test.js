...
describe('ReplyRepositoryPostgres', () => {
    ...
    beforeAll(async () => {
        ...
        await CommentsTableTestHelper.addComment({ id: comment_id, user_id: user_id, thread_id: thread_id });
    });
    ...
    describe('deleteReply function', () => {
        it('should mark reply as deleted', async () => {
            await RepliesTableTestHelper.addReply({ id: 'reply-123', thread_id, user_id, comment_id });
    ...
    describe('getReplyByCommentId function', () => {
        it('should return replies by comment id', async () => {
            await RepliesTableTestHelper.addReply({ id: 'reply-123', thread_id, user_id, comment_id, content: 'This is a reply comment' });
            await RepliesTableTestHelper.addReply({ id: 'reply-124', thread_id, user_id, comment_id, content: 'This is a reply comment 2' });
            const replyRepositoryPostgres = new ReplyRepositoryPostgres(pool, {});
