class DeleteReplyUseCase{
    ...
    async execute(useCasePayload){
        ...
        const { thread_id, comment_id, user_id, reply_id } = useCasePayload;
    ...
    _validatePayload({ thread_id, comment_id, user_id, reply_id }) {
        if (!thread_id || !comment_id || !user_id || !reply_id) {
